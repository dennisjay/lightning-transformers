...
from lightning_transformers.task.nlp.self_supervised_modeling.config import SelfSupervisedModelingDataConfig


class SelfSupervisedModelingDataModule(HFDataModule):
    ...
    Args:
        *args: ``HFDataModule`` specific arguments.
        cfg: Contains data specific parameters when processing/loading the dataset
            (Default ``SelfSupervisedModelingDataConfig``)
        **kwargs: ``HFDataModule`` specific arguments.
    """

    cfg: SelfSupervisedModelingDataConfig

    def __init__(self, *args, cfg: SelfSupervisedModelingDataConfig = SelfSupervisedModelingDataConfig(), **kwargs) -> None:
